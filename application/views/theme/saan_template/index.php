    ...
    <script type='text/javascript'>
        ...
        $(document).ready(function(){
            $('#username').click(function(){
                if($('#username').val() == "Please Enter Username")
                {
                    $('#username').val('');
                }
            });
            ...
            $('#username').blur(function(){
                if($('#username').val() == "")
                {
                    $('#username').val('Please Enter Username');
                }
            });
            ...
            <tr style="background-color:#fff;">
                <td align="center">
                    <table align="center" cellpadding="3" cellspacing="3">
                        <tr>
                            <td align="center"><?=General::getMessage()?></td>
                        </tr>
                        <tr>
                            <td align="center">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td align="left"><input type="submit" name="btnSubmit" id="btnSubmit" value="Log In"/></td>
                        </tr>
                        <tr>
                            <td align="center">&nbsp;</td>
                        </tr>
