                                ...
                                <table width="100%" border="0" align="left" class="shadow">
                                    <tr>
                                        <td colspan="2" class="page_heading"><h2>Admin Panel :: Inventory Management
                                            System - <span>Import Product</span></h2></td>
                                    </tr>
                                    <tr>
...
<tr>
                                                        <td>Seelct Product CSV:</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="file" name="import_product" id="import_product" ></td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td><label>
                                                          <input type="submit" name="btnSubmit" id="btnSubmit" value="Import Product">
                                                        </label></td>
                                                    </tr>
                                                </table>
                                          </form>
