                                ...
                                <table width="100%" border="0" align="left" class="shadow">
                                    <tr>
                                        <td colspan="2" class="page_heading"><h2>Admin Panel :: Inventory Management
                                            System - <span>Import Product Category</span></h2></td>
                                    </tr>
                                    <tr>
...
<tr>
                                                        <td>Seelct Category CSV:</td>
                                                    </tr>
                                                    <tr>
                                                        <td><input type="file" name="import_category" id="import_category" ></td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td><label>
                                                          <input type="submit" name="btnSubmit" id="btnSubmit" value="Import Product Category">
                                                        </label></td>
                                                    </tr>
                                                </table>
                                          </form>
