                  ...
                  <tr>
                    <td colspan="2"><form name="form1" method="post" action="">
                        <table width="70%" border="0" align="center" cellpadding="3" cellspacing="3">
                          ...
                          <tr>
                            <td><select name="product_category_name" id="select">
                            ...
                            if(is_array($productCategoryArray) && count($productCategoryArray) > 0)
                            {
                                ...
                                {
                                ?>
                            <option value="<?=$prodCatValue['product_category_id']?>" <?=($prodCatValue['product_category_id'] == $RetainArray['product_category_name'])?'selected':''?> ><?=$prodCatValue['product_category_name']?></option>
                                <?php
                                }
                            }
                            ?>
