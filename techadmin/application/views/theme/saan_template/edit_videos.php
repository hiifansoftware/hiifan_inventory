            ...
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                ...
                <tr>
                    <td><input type="file" name="file" id="file">
                        <br>Present Video: <br><img
                                src="<?=__ADMIN_UPLOAD_URL . "videos/" . $VideoArray[0]['video_id']?>.jpg" width="60"
                                height="60">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><textarea name="video_tagline"
                                  id="video_tagline"><?=$VideoArray[0]['video_tagline']?></textarea></td>
                </tr>
