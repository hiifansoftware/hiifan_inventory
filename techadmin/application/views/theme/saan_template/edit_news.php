    ...
    <div id="content" class="box">
        ...
        <form name="form1" method="post" action="<?=__SITE_URL?>adminhome/edit_news">
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                <tr>
                    <td>
                        <div class="help_text" style="color:#FF3300;"></div>
                    </td>
                </tr>
                <tr>
                    <td>News Category:</td>
                ...
                <tr>
                    <td><select name="news_content_type" id="news_content_type">
                        ...
                        <option value="video" <?php echo ($PostRetain['news_content_type'] == "video") ? "selected" : "" ?>>
                            Video
                        </option>
                        <option value="photo" <?php echo ($PostRetain['news_content_type'] == "photo") ? "selected" : "" ?>>
                            Photo
                        </option>
                        <option value="both" <?php echo ($PostRetain['news_content_type'] == "both") ? "selected" : "" ?>>
                            Both
                        </option>
                        <option value="none" <?php echo ($PostRetain['news_content_type'] == "none") ? "selected" : "" ?>>
                            None
                        </option>
                    </select>
                    </td>
                ...
                <tr>
                    <td><textarea name="news_meta_description"
                                  id="news_meta_description"><?=$PostRetain['news_meta_description']?>
                    </textarea></td>
                </tr>
                <tr>
