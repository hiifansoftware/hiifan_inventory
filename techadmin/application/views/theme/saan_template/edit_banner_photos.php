            ...
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                ...
                <tr>
                    <td><input type="file" name="file" id="file">
                        <br>Present Photo: <br><img
                                src="<?=__ADMIN_UPLOAD_URL . "banner_photos/" . $BannerPhotoArray[0]['banner_photo_id']?>.jpg"
                                width="60" height="60">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><textarea name="banner_photo_tagline"
                                  id="banner_photo_tagline"><?=$BannerPhotoArray[0]['banner_photo_tagline']?></textarea>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><textarea name="banner_photo_description"
                                  id="banner_photo_description"><?=$BannerPhotoArray[0]['banner_photo_description']?></textarea>
                    </td>
                </tr>
